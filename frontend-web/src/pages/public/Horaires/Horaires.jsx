...
//            Tableau statique des heures Lun–Dim + informations
//            sur les types d'accueil (plein temps, partiel, occasionnel).
// ============================================================

import './Horaires.css';

// ── Données statiques des horaires ────────────────────────────
// ouvert:false = Sam et Dim sont affichés en grisé "Fermé"
const JOURS = [
    ...
    <section className="section-blanche">
      <div className="container">
        ...
        <div className="horaires-tableau">
          {/* Ligne pour chaque jour : ouvert → heure de début/fin, fermé → "Fermé" */}
        ...
        {/* Encarts d'information : jours fériés + signalement d'absence */}
